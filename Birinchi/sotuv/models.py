...
class Kurs(models.Model):
    ...
    daraja=models.CharField(max_length=20,choices=[("boshlangich","boshlangich"),("orta","orta"),("yuqori","yuqori")])
...
class Xarid(models.Model):
    ...
    holat=models.CharField(max_length=20,choices=[("tugadi", "tugadi"), ("davomiy", "davomiy"), ("boshlanmagan", "boshlanmagan")])
